  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      <div class="row">
        ...
        @if($groups->count() == 0)
          <span class="border border-danger text-center" style="background-color: #ffcc9d;">Ma'lumotlariz ushbu tizimda topilmadi. Agar hemis tizimidan ma'lumotlarni olishni istasangiz quyidagi giper matnni bosing. 
